...
resource "aws_iam_policy" "mlb_statsapi_states_gameday_set_scheduled_games_lambda_logs_policy" {
  name = "mlb_statsapi_states_gameday_set_scheduled_games_lambda_logs_policy-${var.aws_region}"
    ...
    Statement = [
      {
        ...
        Action = "logs:*"
        Resource = [
          aws_cloudwatch_log_group.mlb_statsapi_states_gameday_set_scheduled_games_lambda-Logs.arn
        ]
      }
    ]
  })
  ...
  depends_on = [
    aws_cloudwatch_log_group.mlb_statsapi_states_gameday_set_scheduled_games_lambda-Logs
  ]
}
...
resource "aws_iam_role_policy_attachment" "mlb_statsapi_states_gameday_set_scheduled_games_lambda_role__mlb_statsapi_states_gameday_set_scheduled_games_lambda_logs_policy" {
  ...
  role = aws_iam_role.mlb_statsapi_states_gameday_set_scheduled_games_lambda_role.name
  depends_on = [
    aws_iam_policy.mlb_statsapi_states_gameday_set_scheduled_games_lambda_logs_policy,
    aws_iam_role.mlb_statsapi_states_gameday_set_scheduled_games_lambda_role
  ]
}


resource "null_resource" "mlb_statsapi_states_gameday_set_scheduled_games_lambda_zip" {
  triggers = {
...
resource "aws_lambda_function" "mlb_statsapi_states_gameday_set_scheduled_games_lambda" {
  function_name = local.function_name
  handler = local.handler
  //noinspection HILUnresolvedReference
  role = aws_iam_role.mlb_statsapi_states_gameday_set_scheduled_games_lambda_role.arn
  ...
  depends_on = [
    aws_iam_role.mlb_statsapi_states_gameday_set_scheduled_games_lambda_role,
    null_resource.mlb_statsapi_states_gameday_set_scheduled_games_lambda_zip
  ]
}

output "mlb_statsapi_states_gameday_set_scheduled_games_lambda-function_name" {
  value = aws_lambda_function.mlb_statsapi_states_gameday_set_scheduled_games_lambda.function_name
}

output "mlb_statsapi_states_gameday_set_scheduled_games_lambda-arn" {
  //noinspection HILUnresolvedReference
  value = aws_lambda_function.mlb_statsapi_states_gameday_set_scheduled_games_lambda.arn
}